...
return array(
    ...
    'import' => array(
        ...
        'application.models.asia.*',
        'application.models.thangbom.*',
    ...
    'components' => array(
        ...
        'urlManager' => array(
            ...
            'rules' => array(
                ...
                'video-chi-tiet/<slug:[a-zA-Z0-9-]+>' => 'site/videoDetail',
                ...
                // 'lifestyle-detail/<slug:[a-zA-Z0-9-]+>' => 'site/lifestyleDetail',
                // 'property-listing/<position:[a-zA-Z0-9-]+>' => 'site/propertyListing',
                // 'property-listing' => 'site/propertyListing',
                // 'property-listing-detail/<slug:[a-zA-Z0-9-]+>' => 'site/propertyListingDetail',
                // 'services' => 'site/services',
                // 'service-detail/<slug:[a-zA-Z0-9-]+>' => 'site/serviceDetail',
                // 'home-product-<HomeProducts_page:[a-zA-Z0-9-]+>' => 'site/homeProduct',
                // 'home-product' => 'site/homeProduct',
                // 'home-product-detail/<slug:[a-zA-Z0-9-]+>' => 'site/homeProductDetail',
                ...
                'stationery/<slug:[a-zA-Z0-9-]+>' => 'stationeries/index',
                'price-calculator/<slug:[a-zA-Z0-9-]+>' => 'printSolutions/priceCalculator',
