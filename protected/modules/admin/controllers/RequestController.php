...
{
    public $pluralTitle = 'Request Management';
    public $singleTitle = 'Request';
    public $cannotDelete = array();
    // public function actionCreate(){
    //     try {
    //         $model = new Request('create');
    ...
    public function actionIndex() {
        try {
            ...
            if(isset($_GET['Request']))
            {
                ...
                $model->search_date=$_GET['Request']['search_date'];
            }
	...
	*/
	...
	{
		$deleteItems = $_POST['request-grid_c0'];
		$shouldDelete = array_diff($deleteItems, $this->cannotDelete);

		if (!empty($shouldDelete))
		{
						Request::model()->deleteAll('id in (' . implode(',', $shouldDelete) . ')');
