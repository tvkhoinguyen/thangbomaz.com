...
class PropertyListingsController extends AdminController
{
    public $pluralTitle = 'Property Listing Management';
    public $singleTitle = 'Property Listing';
    public $cannotDelete = array();
    public function actionCreate(){
        try {
            $model = new PropertyListing('create');
	...
	*/
	...
	{
		$deleteItems = $_POST['property-listing-grid_c0'];
		$shouldDelete = array_diff($deleteItems, $this->cannotDelete);

		if (!empty($shouldDelete))
		{
						PropertyListing::model()->deleteAll('id in (' . implode(',', $shouldDelete) . ')');
