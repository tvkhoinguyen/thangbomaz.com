...
{
    public $pluralTitle = 'Service Management';
    public $singleTitle = 'Service';
    public $cannotDelete = array();
    public function actionCreate(){
        try {
            $model = new Services('create');
    ...
    */
    ...
    {
            $deleteItems = $_POST['services-grid_c0'];
            $shouldDelete = array_diff($deleteItems, $this->cannotDelete);

            if (!empty($shouldDelete))
            {
                                            Services::model()->deleteAll('id in (' . implode(',', $shouldDelete) . ')');
