...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('category-video-grid', {
...
$('#clearsearch').click(function(){
	...
	$.fn.yiiGridView.update('category-video-grid', {data: data});
	return false;
});

$('.deleteall-button').click(function(){
        var atLeastOneIsChecked = $('input[name=\"category-video-grid_c0[]\"]:checked').length > 0;
        ...
        {
                document.getElementById('category-video-grid-bulk').action='" . Yii::app()->createAbsoluteUrl('admin/' . Yii::app()->controller->id  . '/deleteall') . "';
                document.getElementById('category-video-grid-bulk').submit();
        }
});
...
Yii::app()->clientScript->registerScript('ajaxupdate', "
    $('#category-video-grid a.ajaxupdate').live('click', function() {
        $.fn.yiiGridView.update('category-video-grid', {
            type: 'POST',
            url: $(this).attr('href'),
            success: function() {
