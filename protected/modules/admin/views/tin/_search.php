  ...
  <div class="panel-body">
	...
	<?php $form = $this->beginWidget('CActiveForm', array(
		...
		'htmlOptions' => array('class' => 'form-horizontal', 'role' => 'form', 'id' => 'search-form'),
			...
			<div class="col-sm-4">
				<div class="form-group form-group-sm">
					<?php echo $form->labelEx($model,'get_from', array('class' => 'col-sm-3 control-label')); ?>
					<div class="col-sm-7">
						<?php echo $form->textField($model,'get_from', array('class' => 'form-control')); ?>
			...
			<div class="col-sm-4">
				<div class="form-group form-group-sm">
					...
					<div class="col-sm-7">
						<?php echo $form->textField($model,'category_parent_id', array('class' => 'form-control')); ?>
			...
			<div class="col-sm-4">
				<div class="form-group form-group-sm">
					...
					<div class="col-sm-7">
						<?php echo $form->textField($model,'category_sub_id', array('class' => 'form-control')); ?>
			...
			<div class="col-sm-4">
				<div class="form-group form-group-sm">
					<?php echo $form->labelEx($model,'view', array('class' => 'col-sm-3 control-label')); ?>
					<div class="col-sm-7">
						<?php echo $form->textField($model,'view', array('class' => 'form-control')); ?>
			...
			<div class="col-sm-4">
				<div class="form-group form-group-sm">
					...
					<div class="col-sm-7">
						<?php echo $form->textField($model,'is_home', array('class' => 'form-control')); ?>
