<div class="panel panel-default">
	<div class="panel-heading">
		<h3 class="panel-title"><span class="<?php echo $model->isNewRecord ? $this->iconCreate : $this->iconEdit; ?>"></span> Update KhungBanner2</h3>
	</div>
	<div class="panel-body">
        ...
        <div class='form-group form-group-sm'>
			...
			Recommended Size: <?php echo KhungBanner2::WIDTH ?>px x <?php echo KhungBanner2::HEIGHT ?>px (width x height). Allow: *.jpg, *.png, *.gif
		...
		<div class='form-group form-group-sm'>
			...
			<div class="col-sm-6">
				...
				{
					// echo $model->image;
					// echo ImageHelper::getImageUrl($model, 'image', KhungBanner2::SIZE );
					echo '<img src="'.ImageHelper::getImageUrl($model, 'image', KhungBanner2::SIZE ).'" />';
