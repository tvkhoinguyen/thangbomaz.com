	...
	<div class="panel-body">
		...
		<?php $form=$this->beginWidget('CActiveForm', array(
			...
			<div class='form-group form-group-sm'>
					<?php echo $form->labelEx($model,'price_from', array('class' => 'col-sm-1 control-label')); ?>
					<div class="col-sm-3">
						<?php echo $form->textField($model,'price_from', array('class' => 'form-control', 'maxlength' => 255)); ?>
						<?php echo $form->error($model,'price_from'); ?>
					</div>
			</div>
			<div class='form-group form-group-sm'>
					<?php echo $form->labelEx($model,'price_to', array('class' => 'col-sm-1 control-label')); ?>
					<div class="col-sm-3">
						<?php echo $form->textField($model,'price_to', array('class' => 'form-control', 'maxlength' => 255)); ?>
