...
$this->menu=array(
	array('label'=>'Create Sub Category', 'url'=>array('createSub', 'p_id'=>$p_id) ),
	// array('label'=>'Create Sub Category', 'url'=> Yii::app()->createAbsoluteUrl('admin/categoryTin/createSub', array('p_id'=>$p_id)) ),
);
	...
	<div class="panel-body">
		<?php 
			...
			$columnArray =array(
				...
				array(
					...
					'buttons' => array(
							...
							'update' => array(
								'url' => 'Yii::app()->createAbsoluteUrl("admin/categoryTin/updateSub", array("id"=>$data->id,"p_id"=>$data->parent_id)) '
								),
							'view' => array(
								'url' =>' Yii::app()->createAbsoluteUrl("admin/categoryTin/viewSub", array("id"=>$data->id, "p_id"=>$data->parent_id )) '
								)
					), 
				),
			);
			...
			$this->widget('zii.widgets.grid.CGridView', array(
				...
				'dataProvider'=>$model->search($p_id),
				'pager'=>array(
							'header'         => '',
							'prevPageLabel'  => 'Prev',
