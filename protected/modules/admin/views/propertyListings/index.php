...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('property-listing-grid', {
...
$('#clearsearch').click(function(){
	...
	$.fn.yiiGridView.update('property-listing-grid', {data: data});
	return false;
});

$('.deleteall-button').click(function(){
        var atLeastOneIsChecked = $('input[name=\"property-listing-grid_c0[]\"]:checked').length > 0;
        ...
        {
                document.getElementById('property-listing-grid-bulk').action='" . Yii::app()->createAbsoluteUrl('admin/' . Yii::app()->controller->id  . '/deleteall') . "';
                document.getElementById('property-listing-grid-bulk').submit();
        }
});
...
Yii::app()->clientScript->registerScript('ajaxupdate', "
    $('#property-listing-grid a.ajaxupdate').live('click', function() {
        $.fn.yiiGridView.update('property-listing-grid', {
            type: 'POST',
            url: $(this).attr('href'),
            success: function() {
