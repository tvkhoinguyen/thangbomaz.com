...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('khung-banner1-grid', {
...
$('#clearsearch').click(function(){
	...
	$.fn.yiiGridView.update('khung-banner1-grid', {data: data});
	return false;
});

$('.deleteall-button').click(function(){
        var atLeastOneIsChecked = $('input[name=\"khung-banner1-grid_c0[]\"]:checked').length > 0;
        ...
        {
                document.getElementById('khung-banner1-grid-bulk').action='" . Yii::app()->createAbsoluteUrl('admin/' . Yii::app()->controller->id  . '/deleteall') . "';
                document.getElementById('khung-banner1-grid-bulk').submit();
        }
});
...
Yii::app()->clientScript->registerScript('ajaxupdate', "
    $('#khung-banner1-grid a.ajaxupdate').live('click', function() {
        $.fn.yiiGridView.update('khung-banner1-grid', {
            type: 'POST',
            url: $(this).attr('href'),
            success: function() {
		...
		<?php 
			...
			$columnArray = array_merge($columnArray, array(
				...
				array(
					...
					'value' => 'isset($data)
				                ?
				                    CHtml::image(ImageHelper::getImageUrl($data, "image", KhungBanner1::SIZE ) )
				                :"";',
