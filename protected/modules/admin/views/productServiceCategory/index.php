...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('product-service-category-grid', {
...
$('#clearsearch').click(function(){
	...
	$.fn.yiiGridView.update('product-service-category-grid', {data: data});
	return false;
});

$('.deleteall-button').click(function(){
        var atLeastOneIsChecked = $('input[name=\"product-service-category-grid_c0[]\"]:checked').length > 0;
        ...
        {
                document.getElementById('product-service-category-grid-bulk').action='" . Yii::app()->createAbsoluteUrl('admin/' . Yii::app()->controller->id  . '/deleteall') . "';
                document.getElementById('product-service-category-grid-bulk').submit();
        }
});
...
Yii::app()->clientScript->registerScript('ajaxupdate', "
    $('#product-service-category-grid a.ajaxupdate').live('click', function() {
        $.fn.yiiGridView.update('product-service-category-grid', {
            type: 'POST',
            url: $(this).attr('href'),
            success: function() {
...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<?php 
			...
			'id'=>'product-service-category-grid-bulk',
			...
			$this->widget('zii.widgets.grid.CGridView', array(
				'id'=>'product-service-category-grid',
