...
$('#clearsearch').click(function(){
	...
	$.fn.yiiGridView.update('services-grid', {data: data});
	return false;
});

$('.deleteall-button').click(function(){
        var atLeastOneIsChecked = $('input[name=\"services-grid_c0[]\"]:checked').length > 0;
        ...
        {
                document.getElementById('services-grid-bulk').action='" . Yii::app()->createAbsoluteUrl('admin/' . Yii::app()->controller->id  . '/deleteall') . "';
                document.getElementById('services-grid-bulk').submit();
        }
});
...
Yii::app()->clientScript->registerScript('ajaxupdate', "
    $('#services-grid a.ajaxupdate').live('click', function() {
        $.fn.yiiGridView.update('services-grid', {
            type: 'POST',
            url: $(this).attr('href'),
            success: function() {
