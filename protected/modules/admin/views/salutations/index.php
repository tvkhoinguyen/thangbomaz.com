...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('salutations-grid', {
...
$('#clearsearch').click(function(){
	...
	$.fn.yiiGridView.update('salutations-grid', {data: data});
	return false;
});

$('.deleteall-button').click(function(){
        var atLeastOneIsChecked = $('input[name=\"salutations-grid_c0[]\"]:checked').length > 0;
        ...
        {
                document.getElementById('salutations-grid-bulk').action='" . Yii::app()->createAbsoluteUrl('admin/' . Yii::app()->controller->id  . '/deleteall') . "';
                document.getElementById('salutations-grid-bulk').submit();
        }
});
...
Yii::app()->clientScript->registerScript('ajaxupdate', "
    $('#salutations-grid a.ajaxupdate').live('click', function() {
        $.fn.yiiGridView.update('salutations-grid', {
            type: 'POST',
            url: $(this).attr('href'),
            success: function() {
