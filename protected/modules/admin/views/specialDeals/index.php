...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('special-deals-grid', {
...
$('#clearsearch').click(function(){
	...
	$.fn.yiiGridView.update('special-deals-grid', {data: data});
	return false;
});

$('.deleteall-button').click(function(){
        var atLeastOneIsChecked = $('input[name=\"special-deals-grid_c0[]\"]:checked').length > 0;
        ...
        {
                document.getElementById('special-deals-grid-bulk').action='" . Yii::app()->createAbsoluteUrl('admin/' . Yii::app()->controller->id  . '/deleteall') . "';
                document.getElementById('special-deals-grid-bulk').submit();
        }
});
...
Yii::app()->clientScript->registerScript('ajaxupdate', "
    $('#special-deals-grid a.ajaxupdate').live('click', function() {
        $.fn.yiiGridView.update('special-deals-grid', {
            type: 'POST',
            url: $(this).attr('href'),
            success: function() {
