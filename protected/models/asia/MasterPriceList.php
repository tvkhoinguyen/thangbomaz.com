 ...
 */
class MasterPriceList extends _BaseModel {
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, price_from,price_to, display_order, status, created_date', 'safe'),
		);
	}
	 ...
	 * @return MasterPriceList the static model class
	 */
