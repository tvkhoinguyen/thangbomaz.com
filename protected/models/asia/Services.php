...
/**
 * This is the model class for table "{{_services}}".
 *
 * The followings are the available columns in table '{{_services}}':
 * @property integer $id
 ...
 */
class Services extends _BaseModel {
	public $category;	
        public $uploadImageFolder = 'upload/services'; //remember remove ending slash
	...
	public function rules()
	{
		...
		return array(
			...
			array('content, slug, category, featured_image, is_featured, product_service_id', 'safe'),
                        array('name, content', 'required', 'on' => 'create, update'), 
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, content, address, telephone, website, status, created_date', 'safe', 'on'=>'search'),
		);
	}
	...
	public function nextOrderNumber()
	{
        ...
        public static function findBySlug($slug) {
            $criteria=new CDbCriteria;
            $criteria->compare('t.slug', $slug, true);
